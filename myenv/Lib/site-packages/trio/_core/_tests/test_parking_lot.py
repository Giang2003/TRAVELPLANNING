...
from .._parking_lot import Bãi đậu xeLot
...
async def test_parking_lot_basic() -> None:
    ...
    async def waiter(i: int, lot: Bãi đậu xeLot) -> None:
...
async def cancellable_waiter(
    name: T, lot: Bãi đậu xeLot, scopes: dict[T, _core.CancelScope], record: list[str]
) -> None:
